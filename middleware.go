...
func (a *App) setupMiddleware() {
	...
	e.Use(middleware.SecureWithConfig(middleware.SecureConfig{
		...
		ContentSecurityPolicy: "default-src 'self'; script-src 'self' 'unsafe-inline' 'wasm-unsafe-eval' https://cloud.umami.is https://plausible.io https://nanolytica.org https://www.googletagmanager.com blob:; style-src 'self' 'unsafe-inline'; img-src 'self' https: data:; font-src 'self'; connect-src 'self' data: blob: https://plausible.io https://api-gateway.umami.dev https://nanolytica.org https://www.google-analytics.com https://www.googletagmanager.com; worker-src 'self' blob:; media-src 'self' data:",
		HSTSMaxAge:            31536000,
